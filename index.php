        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.php" class="app-brand-link">
              ...
              <svg width="300" height="200" viewBox="57 20 20 120" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <!-- New gradient for the body in blue tones -->
    <linearGradient id="metalGradientBody" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="10%" style="stop-color:#000000;stop-opacity:1" />
      <stop offset="65%" style="stop-color:#800000;stop-opacity:1" />
      <stop offset="100%" style="stop-color:#000000;stop-opacity:1" />
      
    </linearGradient>

    <!-- New gradient for the lid in blue tones -->
    <linearGradient id="metalGradientLid" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#ffc602;stop-opacity:1" />
      <stop offset="50%" style="stop-color:#a10605;stop-opacity:1" />
      <stop offset="100%" style="stop-color:#ffc602;stop-opacity:1" />
    </linearGradient>
    ...
    <path id="can-body" d="M18 20 Q16 20 16 22 L16 54 Q16 56 18 56 L46 56 Q48 56 48 54 L48 22 Q48 20 46 20 Z"></path>
    
    <!-- Trash can lid -->
    <path id="can-lid" d="M20 14 Q18 14 18 16 L18 18 L46 18 L46 16 Q46 14 44 14 Z"></path>
    
    <!-- Handle -->
    <path id="can-handle" d="M27 10 Q26 10 26 11 L26 13 L38 13 L38 11 Q38 10 37 10 Z"></path>
  </defs>

  <!-- Main logo with updated colors -->
  <g id="trash-logo" fill="none" fill-rule="evenodd" transform="scale(2)">
    <use fill="url(#metalGradientBody)" xlink:href="#can-body"></use>
    <!-- Adding a deeper shadow effect -->
    <ellipse cx="32" cy="58" rx="16" ry="2" fill="url(#shadowGradient)" opacity="0.5"></ellipse>

    <use fill="url(#metalGradientLid)" xlink:href="#can-lid" transform="translate(0, -1)"></use>
    <!-- More defined shadow under the lid -->
    <ellipse cx="32" cy="19" rx="16" ry="1.5" fill="url(#shadowGradient)" opacity="0.3"></ellipse>

    <use fill="url(#metalGradientLid)" xlink:href="#can-handle"></use>
    <!-- Adding subtle shadow for depth -->
    <ellipse cx="32" cy="13" rx="6" ry="1" fill="url(#shadowGradient)" opacity="0.4"></ellipse>
  </g>
</svg>
=
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-3">binovation</span>
            </a>
