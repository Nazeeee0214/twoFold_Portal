...
try {
    // Get total records for the logged-in user excluding rows with zero pts_earned and bottle_quantity
    $totalQuery = $pdo->prepare("SELECT COUNT(*) FROM transaction_history 
                                 WHERE user_id = :user_id 
                                 AND NOT (pts_earned = 0 AND bottle_quantity = 0)");
    ...
    $dataQuery = "SELECT id, user_id, pts_earned, bottle_quantity, timestamp 
